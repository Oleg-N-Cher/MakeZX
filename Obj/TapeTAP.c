...
static void TapeTAP_TapeFile_WriteBasicHeader (TapeTAP_TapeFile *tap, LONGINT *tap__typ, CHAR *name, LONGINT name__len, INTEGER startLine, INTEGER dataLength);
...
#define __TapeTAP_TapeFile_WriteBasicHeader(tap, tap__typ, name, name__len, startLine, dataLength) __SEND(tap__typ, TapeTAP_TapeFile_WriteBasicHeader, 3, void(*)(TapeTAP_TapeFile*, LONGINT *, CHAR*, LONGINT , INTEGER, INTEGER), (tap, tap__typ, name, name__len, startLine, dataLength))
#define __TapeTAP_TapeFile_WriteByte(tap, tap__typ, b) __SEND(tap__typ, TapeTAP_TapeFile_WriteByte, 4, void(*)(TapeTAP_TapeFile*, LONGINT *, SYSTEM_BYTE), (tap, tap__typ, b))
#define __TapeTAP_TapeFile_WriteCheckSum(tap, tap__typ) __SEND(tap__typ, TapeTAP_TapeFile_WriteCheckSum, 5, void(*)(TapeTAP_TapeFile*, LONGINT *), (tap, tap__typ))
#define __TapeTAP_TapeFile_WriteCodeBody(tap, tap__typ, dataLength, data, data__len) __SEND(tap__typ, TapeTAP_TapeFile_WriteCodeBody, 6, void(*)(TapeTAP_TapeFile*, LONGINT *, INTEGER, SYSTEM_BYTE*, LONGINT ), (tap, tap__typ, dataLength, data, data__len))
#define __TapeTAP_TapeFile_WriteCodeHeader(tap, tap__typ, name, name__len, dataStartAddr, dataLength) __SEND(tap__typ, TapeTAP_TapeFile_WriteCodeHeader, 7, void(*)(TapeTAP_TapeFile*, LONGINT *, CHAR*, LONGINT , INTEGER, INTEGER), (tap, tap__typ, name, name__len, dataStartAddr, dataLength))
#define __TapeTAP_TapeFile_WriteWord(tap, tap__typ, w) __SEND(tap__typ, TapeTAP_TapeFile_WriteWord, 8, void(*)(TapeTAP_TapeFile*, LONGINT *, INTEGER), (tap, tap__typ, w))
...
static void TapeTAP_TapeFile_WriteBasicHeader (TapeTAP_TapeFile *tap, LONGINT *tap__typ, CHAR *name, LONGINT name__len, INTEGER startLine, INTEGER dataLength)
{
	...
	if (startLine >= 0 && startLine <= 9999 || startLine == 32768) {
		__TapeTAP_TapeFile_WriteWord(&*tap, tap__typ, startLine);
	} else {
		(*tap).error = 1;
	}
	__TapeTAP_TapeFile_WriteWord(&*tap, tap__typ, dataLength);
...
__TDESC(TapeTAP_TapeFile, 10, 0) = {__TDFLDS("TapeFile", 16), {-4}};
...
export void *TapeTAP__init(void)
{
	...
	__INITBP(TapeTAP_TapeFile, TapeTAP_TapeFile_WriteBasicHeader, 3);
	__INITBP(TapeTAP_TapeFile, TapeTAP_TapeFile_WriteByte, 4);
	__INITBP(TapeTAP_TapeFile, TapeTAP_TapeFile_WriteCheckSum, 5);
	__INITBP(TapeTAP_TapeFile, TapeTAP_TapeFile_WriteCodeBody, 6);
	__INITBP(TapeTAP_TapeFile, TapeTAP_TapeFile_WriteCodeHeader, 7);
	__INITBP(TapeTAP_TapeFile, TapeTAP_TapeFile_WriteWord, 8);
/* BEGIN */
	__ENDMOD;
}
